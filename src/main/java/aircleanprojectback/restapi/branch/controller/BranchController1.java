...
//import aircleanprojectback.restapi.member.dto.BranchOwnerDTO;
...
//        System.out.println("branchInfo 동작");
//
//        List<BranchOwnerDTO> branchList = service.findBranch();
//
//        return ResponseEntity.ok().body(new ResponseDTO(HttpStatus.OK,"branch Info 조회 성공","간디"));
//    }
////
////
